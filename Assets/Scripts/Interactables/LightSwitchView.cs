...
public class LightSwitchView : MonoBehaviour, IInteractable
{
    ...
    private void OnEnable()
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.AddListener(onLightTunredOffByGhost);
    }

    private void OnDisable()
    {
        EventService.Instance.OnLightSwitchToggled.RemoveListener(onLightSwitch);
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(onLightTunredOffByGhost);
    }
    ...
    private void onLightTunredOffByGhost()
    {
        SetLights(false);
